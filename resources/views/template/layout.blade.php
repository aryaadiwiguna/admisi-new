      ...
      <nav class="bg-black border-white-200 dark:bg-gray-900 px-4">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto">
            <a href="https://flowbite.com/" class="flex items-center space-x-3 rtl:space-x-reverse">
                <img src="{{ asset('assets/images/primakara-university.webp') }}" class="h-10" alt="Primakara University Logo" />
            </a>
            <div class="bg-white rounded-full my-4">
                <button type="button"
                    class="flex text-sm p-3 bg-white-800 rounded-full md:me-0"
                    id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown"
                    data-dropdown-placement="bottom">
                    <img class="w-8 h-8 rounded-full mr-2" src="{{ asset('assets/images/Ellipse 2.png') }}" alt="user photo">
    ...
    <footer>
        <nav class="bg-black border-white-200 dark:bg-gray-900 px-4">
            <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-2">
                ...
                <p class="text-white">Handcrafted With <i class="mb-1 text-primary ms-1 icon-sm" data-feather="heart"></i>
                </p>
            </div>
        </nav>
    </footer>
